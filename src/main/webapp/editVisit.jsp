...
<head>
    <meta charset="UTF-8">
    <title><spring:message code="label.editVisit"/></title>
    <style>
        body {
...
<div class="container">
    ...
    <form:form method="post" action="/visits/edit" modelAttribute="visit">
        <form:hidden path="id"/>
        ...
        <div class="form-group">
            ...
            <form:select path="patient.id">
                <c:forEach var="patient" items="${patients}">
                    <form:option value="${patient.id}">${patient.login}</form:option>
                </c:forEach>
            </form:select>
        </div>
        <div class="form-group">
            ...
            <form:select path="visitType.id">
                <form:options items="${visitTypes}" itemValue="id" itemLabel="serviceName"/>
            </form:select>
        </div>
        <div class="form-group">
        ...
        <div>
            <input type="submit" value="Edit Visit" class="btn"/>
        </div>
    </form:form>
</div>
</body>
