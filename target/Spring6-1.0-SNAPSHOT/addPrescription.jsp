...
<div class="container">
    ...
    <form:form method="post" action="/prescriptions/add" modelAttribute="prescription">
        ...
        <div class="form-group">
            <form:label path="medicines">Leki</form:label>
            <form:textarea path="medicines" rows="3"/>
        </div>
        <div>
            <input type="submit" value="Add Prescription" class="btn"/>
        </div>
    </form:form>
</div>
</body>
